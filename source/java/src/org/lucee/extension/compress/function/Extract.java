...
public final class Extract implements Function {
	...
	public static boolean call(PageContext pc, String strFormat, String strSource, String srcTarget) throws PageException {
		...
		else throw eng.getExceptionUtil().createFunctionException(pc, "extract", 1, "format",
		...
		Resource target = singleFileFormat ? eng.getResourceUtil().toResourceNotExisting(pc, srcTarget) : eng.getResourceUtil().toResourceExisting(pc, srcTarget);
